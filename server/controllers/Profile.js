...
exports.unenrollCourse = async (req, res) => {
  try {
    ...
    // Remove the student from the course's enrolled students list
    await Course.findByIdAndUpdate(courseId, {
      $pull: { studentsEnrolled: userId },
    });

    // Remove and detach the course progress for this student/course
    ...
    // Remove this student's rating & review for the course (must be enrolled to review)
...
exports.instructorDashboard = async (req, res) => {
  try {
    ...
    const courseData = courseDetails.map((course) => {
      // Ensure studentsEnrolled is an array; if not, default to an empty array
