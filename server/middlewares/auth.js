...
// Admin credentials (configurable via .env, with safe local-dev defaults)
const adminEmail = process.env.ADMIN_EMAIL || "admin@learnity.local";
...
async function createAdmin() {
  try {
    ...
    // Create a Profile document for the admin (additionalDetails is a required reference)
    ...
    const adminUser = new User({
      ...
      additionalDetails: adminProfile._id, // Reference to the Profile document
    });
