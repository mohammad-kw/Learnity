  ...
  return (
    <>
      <div className={`flex flex-col gap-4 glass-card p-4 text-richblack-5`}>
        ...
        <div className="px-4">
          <div className="space-x-3 pb-4 text-3xl font-semibold gradient-text">
            Rs. {CurrentPrice}
          </div>
          ...
          <div className={``}>
            ...
            <div className="flex flex-col gap-3 text-sm text-richblack-100">
              {course?.instructions?.map((item, i) => {
                return (
                  <p className={`flex items-center gap-2`} key={i}>
                    <BsFillCaretRightFill className="text-purple-200" />
                    <span>{item}</span>
                  </p>
                );
              })}
          ...
          <div className="text-center">
            <button
              className="mx-auto flex items-center gap-2 py-6 text-purple-100 "
              onClick={handleShare}
            >
