...
function CourseDetails() {
  ...
  return (
    <>
      <div className={`relative w-full bg-richblack-800/60 backdrop-blur-md`}>
        {/* Hero Section */}
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = `https://api.dicebear.com/5.x/initials/svg?seed=${instructor.firstName} ${instructor.lastName}`;
                  }}
                />
                <p className="text-sm text-richblack-100">
                  Created By{" "}
                  <span className="text-richblack-5">{`${instructor.firstName} ${instructor.lastName}`}</span>
                </p>
              </div>
              <div className="flex flex-wrap gap-5 text-sm text-richblack-100">
          ...
          {/* Courses Card */}
          <div className="right-[1rem] top-[60px] mx-auto hidden w-1/3 max-w-[410px] translate-y-12 md:translate-y-0 lg:absolute lg:block">
            <CourseDetailsCard
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="my-8 glass-card p-8">
