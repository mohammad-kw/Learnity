...
const ProjectCard = ({ project }) => {
  return (
    <div className="glass-card overflow-hidden transition-all duration-300 transform hover:-translate-y-2 hover:shadow-purple-glow">
      <img
        src={project.image}
        alt={project.title}
      ...
      />
      <div className="p-4">
        <h3 className="text-lg sm:text-xl font-semibold mb-2 text-richblack-5">
          {project.title}
        </h3>
        <p className="text-richblack-300">{project.description}</p>
      </div>
    </div>
  );
};
