    ...
    <>
      <div className="flex flex-col lg:flex-row justify-center lg:justify-between w-11/12 mx-auto max-w-6xl py-16 lg:py-24 bg-richblack-900 rounded-lg shadow-lg">
        <div className="lg:w-3/5 p-8 bg-richblack-800 border border-richblack-600 rounded-lg shadow-md transition-all duration-300 hover:border-richblack-300 hover:shadow-lg">
          <h2 className="text-3xl font-semibold text-center text-richblack-5 mb-4">
            We Value Your Feedback!
          </h2>
          <p className="text-center text-richblack-300 mb-6">
          ...
          <motion.textarea
            className="w-full h-40 p-3 bg-richblack-700 text-richblack-5 placeholder:text-richblack-400 border border-richblack-600 rounded-md shadow-sm focus:outline-none focus:border-purple-300 focus:ring-1 focus:ring-purple-300 transition-all duration-200"
          ...
          <div className="mt-8">
            <button
              className="w-full py-3 bg-brand-gradient text-white font-semibold text-lg rounded-md shadow-purple-glow transition-transform duration-200 hover:scale-95 hover:shadow-none"
